...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
 ...
 if($con_no!="" && $duration!="")
   {
     $sql3="insert into course_duration values('$con_no', '$duration', '$startdate','$enddate','$status')";   // student is the table name
...
?>
<p align=right>
  <button onclick="location.href='courseduration.html'" class="btn btn-1 btn-1b">Next</button>
</p>
</div>
</div>
