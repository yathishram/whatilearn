...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
 ...
 if($cr_no!="" && $resource!="")
   {
     $sql3="insert into course_resource values('$cr_no', '$con_no', '$cid','$resource','$descp')";   // student is the table name
...
?>
<p align=right>
  <button onclick="location.href='courseresource.html'" class="btn btn-1 btn-1b">Next</button>
</p>
</div>
</div>
