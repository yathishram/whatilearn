...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
 ...
 if($sid!="" && $name!="")
   {
     $sql3="insert into course values('$cid', '$sid', '$name','$desp','$start_date','$exp_enddate')";   // student is the table name
...
?>
<p align=right>
  <button onclick="location.href='coursecontent.html'" class="btn btn-1 btn-1b">Next</button>
</p>
</div>
</div>
