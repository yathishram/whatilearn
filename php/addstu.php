...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  $course=$_POST['course'];
 if($sid!="" && $name!="" && $year!="" && $college!="" && $course!="")
   {
     $sql3="insert into student(sid,name,year,college,course) values('$sid', '$name', '$year','$college','$course')";   // student is the table name
...
?>
<p align=right>
  <button onclick="location.href='course.html'" class="btn btn-1 btn-1b">Next</button>
</p>
</div>
</div>
