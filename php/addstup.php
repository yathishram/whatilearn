...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
 ...
 if($sid!="" && $phoneno!="")
   {
     $sql3="insert into studentphone values('$sid', '$phoneno')";   // student is the table name
...
?>
<p align=right>
  <button onclick="location.href='startpage.html'" class="btn btn-1 btn-1b">Next</button>
</p>
</div>
</div>
