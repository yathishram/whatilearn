...
{
  $con_no=$_POST['con_no'];
 $sql="delete from course_duration where con_no='$con_no'";
     if ($con->query($sql) == TRUE) {
         echo "<p> <font face='Roboto Mono', monospace>Record deleted successfully</font></p>";
     } else {
...
?>
<p align=right>
  <button onclick="location.href='course.html'" class="btn btn-1 btn-1b">Back</button>
</p>
</div>
</div>
