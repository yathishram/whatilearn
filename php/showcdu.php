...
{
	$con_no=$_POST['con_no'];
	$sql="select * from course_duration where con_no='$con_no'";
    ...
    <tr>
      ...
      <th scope=\"col\">Status</th>
          ...
          echo "<tbody><tr class=\"table-success\"><th>"  . $row["con_no"]. "</th><td>" . $row["duration"]. "</td><td>". $row["startdate"]. "</td><td>". $row["enddate"]."</td><td>" . $row["status"]. "</td></tr>";
