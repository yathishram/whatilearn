...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    <tr>
      ...
      <th scope=\"col\">course</th>
                ...
                echo "<tbody><tr class=\"table-success\"><th>" . $row["sid"]. "</th><td>". $row["name"]."</td><td>". $row["year"]. "</td><td>" . $row["college"]. "</td><td>" . $row["course"]. "</td></tr>";
		    }
        echo "</tbody>";
		    echo "</table>";
		} else {
		    echo "Sorry Doesnt exist in the database";
		}
		}
